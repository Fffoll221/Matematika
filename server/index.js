...
app.use(express.json({ limit: "25mb" })); // приймаємо великі base64
...
/* ---------- helper для збереження data:URL ---------- */
...
/* =====================================================
   ВІДДАЄМО ЗІБРАНИЙ ФРОНТ (Vite) + SPA fallback
===================================================== */
const DIST_DIR = path.resolve(__dirname, "..", "dist");
app.use(express.static(DIST_DIR, { index: false })); // статичні файли з /dist

// усе, що НЕ /api/* → index.html (SPA маршрути)
